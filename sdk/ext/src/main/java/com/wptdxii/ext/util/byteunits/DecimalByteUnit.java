package com.wptdxii.ext.util.byteunits;

import java.text.DecimalFormat;
import java.text.NumberFormat;

import static com.wptdxii.ext.util.byteunits.UnitUtil.DEFAULT_FORMAT_PATTERN;
import static com.wptdxii.ext.util.byteunits.UnitUtil.multiply;
