...
public class GetVerifyCode {
	...
	public GetVerifyCode(NetResultListener receiveDataListener) {
		this.receiveDataListener = receiveDataListener;
		String url=IpConfig.getUri2("getCode");
		builder= OkHttpUtils.post().url(url);
	}
	
	public void execute(Object... params) {
		key_value.put("module", params[0].toString());
		key_value.put("mobile", params[1].toString());
		key_value.put("exist", params[2].toString());
