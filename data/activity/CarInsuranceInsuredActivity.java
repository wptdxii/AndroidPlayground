...
public class CarInsuranceInsuredActivity extends BaseActivity implements View.OnClickListener,
    ...
    private void initView() {
        RelativeLayout rlBack = (RelativeLayout) findViewById(R.id.iv_back);
        TextView tvTitle = (TextView) findViewById(R.id.tv_text);
        RelativeLayout rlShare = (RelativeLayout) findViewById(R.id.rl_right);
