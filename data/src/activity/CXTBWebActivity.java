...
//        url = IpConfig.getIp6() + "/product-car-app/index.html";
    }
...
//        setting.setAppCacheMaxSize(1024 * 1024 * 8);
        ...
        webView.addJavascriptInterface(new TitleInterface(), "Title"); // window.Title.getTitle(String title);
