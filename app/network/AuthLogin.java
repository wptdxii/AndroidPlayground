...
public class AuthLogin {
    ...
    public AuthLogin(NetResultListener receiveDataListener) {
        this.receiveDataListener = receiveDataListener;
        url = IpConfig.getUri2("login");
    ...
    public void execute(Object... params) {
        ...
        key_value.put("module", params[3].toString());
        key_value.put("code", params[4].toString());
        key_value.put("mold", params[5].toString());
        action = (Integer) params[6];
        bean = (UserBean) params[7];
        Log.i("login----url", url);
        Log.i("login----mobile", params[0].toString());
        Log.i("login----password", params[1].toString());
        Log.i("login----client_type", params[2].toString());
        Log.i("login----module", params[3].toString());
        Log.i("login----code", params[4].toString());
        Log.i("login----mold", params[5].toString());
                ...
                try {
                    if (jsonString.equals("") || jsonString.equals("null")) {
                        ...
                        if (errcode.equals("0")) {
                            ...
                            //2017/01/18加密usrId
                            String usrId=dataObject.getString("uid");
                            //4.1.0目前user_id不加密，不需要编码
                            //						String user_id_encode= URLEncoder.encode(user_id);
                            String user_id_encode = dataObject.getString("user_id");
