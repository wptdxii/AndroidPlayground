...
import com.cloudhome.activity.InsuranceShopListActivity;
...
public class InsuranceShopListAdapter extends BaseAdapter {
	...
	public InsuranceShopListAdapter(Context context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.insurance_shop_list_item,
					parent, false);
			...
			holder.p_expenses_add_rel = (RelativeLayout) convertView.findViewById(R.id.p_expenses_add_rel);
			holder.p_expenses_add_txt = (TextView) convertView.findViewById(R.id.p_expenses_add_txt);
		...
		if(InsuranceShopListActivity.promotion_expenses_show)
		{
			...
			holder.promotion_expenses.setText("推广费:"+ list.get(position).get("rate"));
