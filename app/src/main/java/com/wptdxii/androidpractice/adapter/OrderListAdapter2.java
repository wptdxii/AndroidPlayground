...
import com.cloudhome.activity.OrderPayActivity;
...
public class OrderListAdapter2 extends BaseAdapter {
    ...
    private GiftInsuranceOrderListActivity context;


    public OrderListAdapter2(GiftInsuranceOrderListActivity context, ArrayList<OrderListBean> dataMap) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (itemViewType) {
            ...
            case TYPE_ITEM:
                ...
                if (GiftInsuranceOrderListActivity.ordertype.equals("卡单")) {
                    viewHolder.rel3.setVisibility(View.VISIBLE);
                } else {
                    viewHolder.rel3.setVisibility(View.GONE);
                }

                if (GiftInsuranceOrderListActivity.ordertype.equals("赠险")) {
