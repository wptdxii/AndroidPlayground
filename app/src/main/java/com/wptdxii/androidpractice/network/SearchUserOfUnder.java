...
public class SearchUserOfUnder {
	...
	public SearchUserOfUnder(NetResultListener receiveDataListener) {
		this.receiveDataListener = receiveDataListener;
		String url= IpConfig.getUri2("searchUserOfUnder");
