package com.wptdxii.androidpractice.widget.swiperecycler;
...
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public LinearDividerItemDecoration(Context context, int resId) {
        dividerDrawable = context.getResources().getDrawable(resId);
    }

    public LinearDividerItemDecoration(Context context, int resId, int orientation) {
        dividerDrawable = context.getResources().getDrawable(resId);
