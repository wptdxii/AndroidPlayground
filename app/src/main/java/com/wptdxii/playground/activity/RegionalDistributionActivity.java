...
//					
	...
	protected void resetViewHolder(ViewHolder p_ViewHolder) {
		...
		p_ViewHolder.rd_img21.setImageResource(R.drawable.customer_head);
		p_ViewHolder.rd_img22.setImageResource(R.drawable.customer_head);
		p_ViewHolder.rd_img23.setImageResource(R.drawable.customer_head);
		p_ViewHolder.rd_img24.setImageResource(R.drawable.customer_head);
		p_ViewHolder.rd_img25.setImageResource(R.drawable.customer_head);
