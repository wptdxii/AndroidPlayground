package com.wptdxii.playground.view.iosalertview;
...
public class CustomDialog extends Dialog {
	...
	@SuppressLint("WrongViewCast") public static class Builder {
		...
		@SuppressLint("WrongViewCast") public CustomDialog create() {
			...
			if (message != null) {
				...
				((RelativeLayout) layout.findViewById(R.id.container))
						.removeAllViews();
				((RelativeLayout) layout.findViewById(R.id.container)).addView(
