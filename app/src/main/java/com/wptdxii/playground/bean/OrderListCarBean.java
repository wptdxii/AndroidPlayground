...
public class OrderListCarBean implements Serializable {
	...
	public String getConcretePremium() {
		return concretePremium;
	}

	public void setConcretePremium(String concretePremium) {
		this.concretePremium = concretePremium;
	}

	public String getConcretePremium2() {
		return concretePremium2;
	}

	public void setConcretePremium2(String concretePremium2) {
		this.concretePremium2 = concretePremium2;
	}
}
