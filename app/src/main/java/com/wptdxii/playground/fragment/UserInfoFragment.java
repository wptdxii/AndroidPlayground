...
public class UserInfoFragment extends BaseFragment implements NetResultListener,OnClickListener {
	...
	private void initView(LayoutInflater inflater, ViewGroup container) {
        ...
        toggle_commission.setToggleColor(getResources().getColor(R.color.toggle_on), getResources().getColor(R.color.toggle_off),
...
//		point_url=point_url+"&user_id="+user_id+"&token="+token;
	...
	void initEvent() {
		if (avatar.length() < 6) {
			if (user_type.equals("02")) {
				info_userIcon.setImageResource(R.drawable.customer_head);
			} else {
			...
			if (user_type.equals("02")) {
				...
				Glide.with(UserInfoFragment.this)
					...
					//	.placeholder(R.drawable.head_fail) 占位图
						.error(R.drawable.customer_head)
						.crossFade()
						.into(info_userIcon);
			} else {
    ...
    //            key_commission = sp.getString("USER_NAME", "none");
    //            Log.e(TAG, "onEvent:1111111111111111111111 " + key_commission );
    //            if (!"none".equals(key_commission)) {
    //                isCommissionShown = sp.getBoolean(key_commission, true);
    //            } else {
    //                isCommissionShown = sp.getBoolean("is_commisson_shown", true);
    //            }
    //
    ////            updateToggle();
    //            if (isCommissionShown) {
    ...
    private void changeToggle() {
        //user_state 00已认证 01未认证 02认证中 03认证失败
        //        if (loginString.equals("none")) {
        //            Intent intent = new Intent();
        //            intent.setClass(getActivity(), LoginActivity.class);
        //            getActivity().startActivity(intent);
    ...
    //        String key_commission = sp.getString("Phone_Number", "none");
    //        if (!"none".equals(key_commission)) {
    //            isCommissionShown = sp.getBoolean(key_commission, true);
    //            Log.e(TAG, "onCreateView: " + isCommissionShown);
    //        } else {
    //            isCommissionShown = sp.getBoolean("is_commisson_shown", true);
    //        }
    //    }
