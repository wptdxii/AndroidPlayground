...
public class InvitationActivity extends BaseActivity implements View.OnClickListener, NetResultListener {
    private static final String EVENT_INVITE = "InvitationActivity_Invite";
    ...
    private void initData() {
        ...
        mShareUrl = IpConfig.getIp6() +
                "/invite-friend/invite_friend/wx_page.html?user_id=" + mUserId + "&token=" + mToken;
