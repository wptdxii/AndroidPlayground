...
public class HomeWebShareActivity extends BaseActivity implements NetResultListener {
    ...
    @JavascriptInterface
    public void invite() {
        String shareUrl = IpConfig.getIp6() +
                "/invite-friend/invite_friend/wx_page.html?user_id=" + user_id + "&token=" + token;
        String shareTitle = getString(R.string.invite_share_title);
        String shareDesc = getString(R.string.invite_share_desc);
        BaseUMShare.shareNotQQZone(this, shareTitle, shareDesc, shareUrl, R.drawable.icon_share_logo);
    }
    ...
    public class JumpToOtherInterface {
        ...
        public void orderlist() {
            MyOrderListActivity.activityStart(HomeWebShareActivity.this, true);
            finish();
        }
