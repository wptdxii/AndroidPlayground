...
public class QianDaoActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        iv_head_circle= (CircleImage) findViewById(R.id.iv_avatar);
    ...
    public void showSuccessDialog(String note,String imgUrl) {
        ...
        Glide.with(QianDaoActivity.this)
                ...
                .crossFade()
                .into(iv_qiandao);
        final SkipDialog builder = new SkipDialog(this,contentView, Common.dip2px(this,290),
    ...
    private void showInstructionDialog() {
        ...
        SkipDialog builder = new SkipDialog(this,contentView, Common.dip2px(this,290),
