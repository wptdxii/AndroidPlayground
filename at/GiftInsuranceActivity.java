...
public class GiftInsuranceActivity extends BaseActivity implements View.OnClickListener,NetResultListener{
    private String Event_Get = "GiftInsuranceActivity_Get";
    private String Event_Give = "GiftInsuranceActivity_Give";
    ...
    private void initView() {
        ...
        bottom_line=(View) findViewById(R.id.divider_action);
    ...
    public void onClick(View view) {
        switch (view.getId()){  
            ...
            case R.id.bt_give_me:
                ...
                MobclickAgent.onEvent(this, Event_Get);
                break;
...
//                        Toast.makeText(this,msg,Toast.LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        MobclickAgent.onEvent(this, Event_Give);
    }
}
