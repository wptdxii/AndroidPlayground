...
public class LoginActivity3 extends BaseActivity implements OnClickListener, NetResultListener {
        ...
        requestPermissions(perms, new PermissionListener() {
            ...
            public void onDenied(String[] impermanentDeniedPermissions, String[] permanentDeniedPermissions) {
                if (device_id == null || device_id.equals("")) {
                    device_id = Settings.Secure.getString(LoginActivity3.this.getContentResolver(),
    ...
    private void init() {
        ...
        btn_right = (Button) findViewById(R.id.btn_action);
        tv_title.setText("登录");
        ...
        rb_fast_login = (RadioButton) findViewById(R.id.rbtn_fast_login);
        rb_account_login = (RadioButton) findViewById(R.id.rbtn_account_login);
        et_phone_num = (ClearEditText) findViewById(R.id.et_fast_num);
        et_verify_code = (ClearEditText) findViewById(R.id.et_verify_code);
        fast_login_btn = (Button) findViewById(R.id.btn_fast_login);
        ...
        et_username = (ClearEditText) findViewById(R.id.et_account_num);
        ...
        login_in = (Button) findViewById(R.id.btn_account_login);
        login_forget = (Button) findViewById(R.id.btn_forget_password);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.rl_back:
                intent.setClass(LoginActivity3.this, AllPageActivity.class);
        ...
        switch (action) {
            case FAST_LOGIN:
                ...
                if (flag == MyApplication.DATA_OK) {
                    ...
                    Toast.makeText(LoginActivity3.this, "网络连接失败，请确认网络连接后重试", Toast.LENGTH_SHORT).show();
            ...
            case GET_CODE_FAST_LOGIN:
                if (flag == MyApplication.DATA_OK) {
                    ...
                    Toast.makeText(LoginActivity3.this, codeMsg, Toast.LENGTH_SHORT).show();
                    time.start();
                } else if (flag == MyApplication.NET_ERROR) {
                    Toast.makeText(LoginActivity3.this, "网络连接失败，请确认网络连接后重试", Toast.LENGTH_SHORT).show();
                } else if (flag == MyApplication.DATA_EMPTY) {
    ...
    private void showPromptDialog(String message) {
        CustomDialog.Builder builder = new CustomDialog.Builder(LoginActivity3.this);
        builder.setTitle("提示");
