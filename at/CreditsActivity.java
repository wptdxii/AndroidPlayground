...
public class CreditsActivity extends BaseActivity {
    private String Event_Exchange = "CreditsActivity_Exchange";
    String url;
    ...
    void init() {
        ...
        credits_back = (RelativeLayout) findViewById(R.id.rl_back);
...
//			credits_rel2.setVisibility(View.GONE);
        ...
        credits_rel2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                MobclickAgent.onEvent(CreditsActivity.this, Event_Exchange);
            }
        });
        ...
        credits_rel3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Log.i("积分规则url",url);
                intent.setClass(CreditsActivity.this, ProtocolWebActivity.class);
                CreditsActivity.this.startActivity(intent);
            }
        });
