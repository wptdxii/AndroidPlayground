...
public class CircleImage extends ImageView {  
	...
	private static final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;  
	    ...
	    public CircleImage (Context context, AttributeSet attrs, int defStyle) {  
	        ...
	        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImage_border_width, DEFAULT_BORDER_WIDTH);  
	        mBorderColor = a.getColor(R.styleable.CircleImage_border_color, DEFAULT_BORDER_COLOR);  
