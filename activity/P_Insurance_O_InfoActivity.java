...
import okhttp3.Call;
public class P_Insurance_O_InfoActivity extends BaseActivity {
	...
	private TextView subs_code_txt, period_from, period_to, unit_price,
	...
	private IWXAPI api;
	public static P_Insurance_O_InfoActivity P_Insurance_O_Infoinstance=null;

	private RelativeLayout p_i_o_rel, p_i_o_rel2;
	private TextView weixin_pay, need_pay;
	private String order_id, RBstr, money_pay = "";
	...
	private Handler errcode_handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if (status.equals("false")) {
				...
				Toast.makeText(P_Insurance_O_InfoActivity.this,
	...
	private Handler null_handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			dialog.dismiss();
			Toast.makeText(P_Insurance_O_InfoActivity.this, errmsg,
	...
	private Handler payhandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			Toast.makeText(P_Insurance_O_InfoActivity.this, "正常调起支付",
					Toast.LENGTH_SHORT).show();
			// 在支付之前，如果应用没有注册到微信，应该先调用IWXMsg.registerApp将应用注册到微信

			Log.d("777777", data.prepayId);
			MyApplication.prepay_id = data.prepayId;
			MyApplication.prevoius_page = "";
			api.sendReq(data);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			String img_url = IpConfig.getIp3() + "/"
					+ data.get("img_url").toString();
			if (img_url != null && img_url.length() > 6) {



				Glide.with(P_Insurance_O_InfoActivity.this)
						.load(img_url)
			...
			need_pay.setText("￥" + data.get("amount"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		P_Insurance_O_Infoinstance=this;
	...
	void init() {
		...
		padapter = new PriceAdapter(P_Insurance_O_InfoActivity.this);
		hdapter = new HolderAdapter(P_Insurance_O_InfoActivity.this);
		idapter = new InsuredAdapter(P_Insurance_O_InfoActivity.this);
		odapter = new OtherAdapter(P_Insurance_O_InfoActivity.this);
		bdapter = new BenefitAdapter(P_Insurance_O_InfoActivity.this);
		...
		c_p_orders_back = (RelativeLayout) findViewById(R.id.iv_back);
					...
					if (jsonString == null || jsonString.equals("")
						...
						if (!errcode.equals("0")) {
							...
							for (int i = 0; i < holderArray.length(); i++) {
								...
								map.put("holder_title",
										jsonArray1.getString(0));
								map.put("holder_value",
										jsonArray1.getString(1));
							...
							String relation_ship = dataObject
									.getString("relation_ship");
							String img_url = dataObject
									.getString("img_url");
