...
public class RegisterMsgActivity extends BaseActivity {
	...
	private Handler login_handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if (errcode.equals("0")) {
				...
				setUserInfo(user_id,usrId, sex, idno, token, mobile, type_code,
	...
	private void setUserInfo(String user_id, String usrId,String sex, String idno,
